...
const useStyles = makeStyles((theme) => ({
  ...
  hero: {
    backgroundImage: ` url('https://www.buzzwebzine.fr/wp-content/uploads/2020/06/outils-travail-collaboratif.jpg')`,
    height: "500px",
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card className={classes.card}>
              <CardActionArea>
                ...
                image="https://images.pexels.com/photos/2004161/pexels-photo-2004161.jpeg?uto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
